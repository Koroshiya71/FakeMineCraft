//UniStorm Weather System Editor C# Version 2.4.0 @ Copyright
	...
	public override void OnInspectorGUI () {
		...
		if (TabNumberProp.intValue == 6){
			...
			if (self.UseProceduralLightning == 1){
				...
				self.ProceduralLightningMaxIntensity = EditorGUILayout.IntSlider ("Max Intensity", self.ProceduralLightningMaxIntensity, 50, 200);
				EditorGUILayout.Space();
